<div class="list-group">
    ...
    <a class="list-group-item list-group-item-action{{ Request::segment(2) == 'user' ? ' active' : '' }}" href="{{ route('admin.user') }}"><i class="fa fa-users"></i>کاربران</a>
    <a class="list-group-item list-group-item-action{{ Request::segment(2) == 'page' ? ' active' : '' }}" href="{{ route('admin.page') }}"><i class="fa fa-newspaper-o"></i> محتوا </a>
